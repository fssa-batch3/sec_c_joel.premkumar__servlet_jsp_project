...
<body>
    <div class="header">
        ...
        <div class="search-bar">
            <form action="<%=request.getContextPath()%>/ReadByNameServlet" method="post" class="d-flex">
                <input class="form-control me-2" name="stock_name" type="search" placeholder="Search" aria-label="Search">
